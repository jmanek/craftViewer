	...
	_createClass(Part, [{
		...
		value: function posVec(vec) {
			vec = (function () {
				...
				try {
					for (var _iterator = vec[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						var v = _step.value;
		...
		value: function rotQuat(quat) {
			...
			quat = (function () {
				...
				try {
					for (var _iterator2 = quat[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
						var q = _step2.value;
		...
		value: function threeVec(vec) {
			...
			var vec3 = new THREE.Vector3(-1.0 * vec[0], vec[1], vec[2]);
			// vec3.setZ(-1.0*vec3.z);
			return vec3;
		}
	}, {
		...
		value: function createSubMesh(model, parent) {
			...
			if (model.verts.length == 0) {
				...
				try {
					for (var _iterator4 = model.verts[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
						var v = _step4.value;
				...
				try {
					for (var _iterator5 = model.faces[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
						var f = _step5.value;
			...
			model.localScale = (function () {
				...
				try {
					for (var _iterator6 = model.localScale[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
						var rot = _step6.value;
			...
			model.localRot = (function () {
				...
				try {
					for (var _iterator7 = model.localRot[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
			...
			model.localPos = (function () {
				...
				try {
					for (var _iterator8 = model.localPos[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
			...
			try {
				for (var _iterator9 = model.children[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
		...
		value: function createMesh(model, parent) {
			...
			if (model.verts.length == 0) {
				...
				try {
					for (var _iterator10 = model.verts[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
						var v = _step10.value;
				...
				try {
					for (var _iterator11 = model.faces[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
						var f = _step11.value;
			...
			model.localScale = (function () {
				...
				try {
					for (var _iterator12 = model.localScale[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
						var rot = _step12.value;
			...
			model.localRot = (function () {
				...
				try {
					for (var _iterator13 = model.localRot[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
			...
			model.localPos = (function () {
				...
				try {
					for (var _iterator14 = model.localPos[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
			...
			try {
				for (var _iterator15 = model.children[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
		...
		value: function load(parent, cb) {
			...
			var muPath = 'E:\\Program Files\\Steam\\steamapps\\common\\Kerbal Space Program' + parts[this.name];
			var options = {
			...
			PythonShell.run('muParser.py', options, function (err, results) {
				...
				if (err) {
					...
					_this.createMesh(JSON.parse(results[0]), parent);
